...
class spell_icc_remove_rocket_pack : public SpellScriptLoader
{
    public:
        ...
        class spell_icc_remove_rocket_pack_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
                OnEffect += SpellEffectFn(spell_icc_remove_rocket_pack_SpellScript::HandleEffect, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);  //note
            }
        };
...
class spell_gb_heat_drain : public SpellScriptLoader
{
    public:
        ...
        class spell_gb_heat_drain_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
                OnEffect += SpellEffectFn(spell_gb_heat_drain_SpellScript::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
            }
        };
...
class spell_gb_overheat_drain : public SpellScriptLoader
{
    public:
        ...
        class spell_gb_overheat_drain_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
                OnEffect += SpellEffectFn(spell_gb_overheat_drain_SpellScript::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
            }
        };
...
class spell_gb_burning_pitch : public SpellScriptLoader
{
    public:
        ...
        class spell_gb_burning_pitch_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
                OnEffect += SpellEffectFn(spell_gb_burning_pitch_SpellScript::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY); //note
            }
        };
